...
//   onSwitch?: () => void;    // ✅ switch between popups (from Hero/Sign)
...
//               <div
//                 className={`h-[2px] w-1/2 transition-all duration-300 ${
//                   activeTab === "getstarted"
...
//                           className={`border rounded-md py-3 font-medium ${
//                             profileType === type.key
//                               ? "bg-black text-white"
...
//                   <button
//                     type="submit"
//                     className="w-full px-4 py-3 bg-[var(--accent-color)] text-[var(--button-text)] text-base rounded-md font-semibold mt-10 transition-all duration-300 ease-in-out hover:bg-[var(--accent-hover)] hover:-translate-y-0.5 hover:shadow-[0_6px_20px_var(--shadow-color)] cursor-pointer"
//                   >
